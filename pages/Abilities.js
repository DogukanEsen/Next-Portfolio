...
export default function Home() {
  ...
  return (
    <Layout title={"Abilities"} description={"My Abilities"}>
        ...
        <section className="glass min-h-[80vh] w-[60%] bg-gradient-to-br from-Baslangic-rgba to-Bitis-rgba rounded-[2rem] z-[2]  flex">
          ...
          <div className="flex-[2]">
            <div className="status text-center">
              ...
              <h2>
                Html, Css, node.js <br />
                C, C#, Java, Database Structures
              </h2>
              <h1>
                <b>FrameWorks</b>
              </h1>
              <br />
              <h2>Bootstrap, react, express, next.js</h2>
              <h1>
                <b>Coming Soon</b>
              </h1>
              <br />
              <h2>
                React-native <br /> Figma Design <br /> Docker and Cubernaters
              </h2>
            </div>
          </div>
        </section>
